...
Route::get('/bobotbaru/{id_tanda}/{id_kategori}/delete', 'BobotbaruController@delete');

Route::get('/tampilkategori/{id_tanda}/show', 'TampilkategoriController@index');
Route::get('/tampilkategori', 'TampilkategoriController@index');
Route::get('/tampilkategori/{{$idTanda}}/{id_tanda}/delete', 'TampilkategoriController@delete');

Route::get('/tambahkategori/{id_tanda}/show', 'TambahkategoriController@index');
Route::post('/tambahkategori/insert', 'TambahkategoriController@insert');

Route::get('/hasil', 'HasilController@index');
Route::post('/hasil/hitung', 'HasilController@hitung');
