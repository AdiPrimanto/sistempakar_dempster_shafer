                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="/tandado/{{$tnd->id_tanda}}/edit" class="btn btn-info btn-sm"
                                    data-toggle="modal" data-target="#edit{{$tnd->id_tanda}}"><i class="fa fa-edit"></i>
                                    Edit</a>
                                <a href="/tandado/{{$tnd->id_tanda}}/hapus" class="btn btn-danger btn-sm"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/tandado/{{$tnd->id_tanda}}/update" method="post">
                                            @csrf
                                            <div class="form-group">
                                                <label for="text">Kode Tanda:</label>
                                                <input type="text" name="kode_tanda" class="form-control" readonly
                                                    value="{{$tnd->kode_tanda}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="text">Nama Tanda:</label>
                                                <input type="text" name="nama_tanda" class="form-control"
                                                    value="{{$tnd->nama_tanda}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="text">Nilai Bobot:</label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/tandado/store" method="post">
                        ...
                        <div class="form-group">
                            <label for="text">Bobot Tanda DO:</label>
                            <input type="text" name="bobot_tanda" class="form-control" value="" autocomplete="off">
                        </div>
                        <button class="btn btn-info" type="submit">Simpan</button>
                        <button class="btn btn-danger" type="button" data-dismiss="modal"
                            aria-label="Close">Batal</button>
