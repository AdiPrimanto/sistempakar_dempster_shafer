...
<script>
    ...
    var hasil_fix = []; //menampilkan perhitungan m3, m5, envidential conflict
...
function setData(data){
    ...
    for(var index_1 = 0; index_1 < table.length; index_1++){
        ...
        content_table += `<label class= "mytable"><b>Perhitungan ke - ${index_1}</b></label> <table class="table table-bordered mytable" width="100%" cellspacing="0" id="densitas-awal" >`;
...
>>>>>>> bd39a187499371f08124bd80e8d6ea4ec0873719
