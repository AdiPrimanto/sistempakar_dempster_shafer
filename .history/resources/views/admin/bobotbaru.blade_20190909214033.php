                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="/bobotbaru/{{$tnd->id_kategori}}/show" class="btn btn-info btn-sm"><i
                                        class="fa fa-edit"></i>
                                    Lihat Tanda</a>
                                    {{-- {{$ktgr->id_tanda}} --}}
                                <a href="" class="btn btn-danger btn-sm"
                                    data-toggle="modal" data-target="#hapus{{$tnd->id_kategori}}"><i
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <a href="/bobotbaru/{{$tnd->id_tanda}}/delete" class="btn btn-primary">Ya</a>
