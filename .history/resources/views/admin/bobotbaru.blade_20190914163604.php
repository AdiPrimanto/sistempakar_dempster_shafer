                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align:center">
                                <a href="/tampilkategori/{{$tnd->id_bobotbaru}}/show" class="btn btn-info btn-sm"><i
                                        class="fa fa-edit"></i>
                                    Lihat Kategori</a>
                                    {{-- {{$ktgr->id_tanda}} --}}
                                <a href="" class="btn btn-danger btn-sm"
                                    data-toggle="modal" data-target="#hapus{{$tnd->id_bobotbaru}}"><i
                        ...
                        <div class="modal" id="hapus{{$tnd->id_bobotbaru}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        Yakin ingin menghapus data {{$tnd->nama_bobotbaru}} ?
                                    </div>
                                    <div class="modal-footer">
                                        <a href="/bobotbaru/{{$tnd->id_bobotbaru}}/delete" class="btn btn-primary">Ya</a>
