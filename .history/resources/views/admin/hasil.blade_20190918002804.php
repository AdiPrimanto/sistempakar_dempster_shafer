...
<div class="container-fluid">
    ...
    <div class="col-md-12">
        ...
        <div class="card mx-auto mt-12" id="group-3" style="display:none">
            ...
            <div id="kesimpulan" style="text-align:center">
        ...
        <div class="card mx-auto mt-12" id="group-2" style="display:none">
            ...
            <div id="perhitungan-table" style="text-align:center"></div>
    ...
    function setData(data) {
        ...
        // console.log(table);
            ...
            for (var index = 0; index < list_data.length; index++) {
                ...
                content += '<td style="text-align:center">' + list_data[index]['nama_tanda'] + '</td>';
                content += '<td>' + list_data[index]['gejala'].join() + '</td>';
                content += '<td>' + list_data[index]['belief'] + '</td>';
                content += '<td>' + list_data[index]['plausibility'] + '</td>';
                content += '</tr>';
            }
            ...
            for (var index_1 = 0; index_1 < table.length; index_1++) {
                ...
                content_table +=
                    `<label class= "mytable"><b>Perhitungan ke - ${index_1}</b></label> <table class="table table-bordered mytable" width="100%" cellspacing="0" id="densitas-awal" >`;
                for (var index_2 = 0; index_2 < table[index_1].length; index_2++) {
                    content_table += `<tr>`;
                    content_table += `<td> ${table[index_1][index_2][0]} </td>`;
                    content_table += `<td> ${table[index_1][index_2][1]} </td>`;
                    content_table += `<td> ${table[index_1][index_2][2]} </td>`;
                    content_table += `</tr>`;
