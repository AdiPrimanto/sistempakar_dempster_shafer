...
Route::get('/tampilkategori/{id_tanda}/show', 'BobotbaruController@index');
Route::get('/tampilkategori', 'BobotbaruController@index');
Route::get('/tampilkategori/{id_tanda}/delete', 'BobotbaruController@delete');
