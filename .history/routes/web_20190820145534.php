...
Route::post('/kaidah/store', 'KategoriDOController@store');
Route::get('/kaidah/{id_kategori}/edit', 'KategoriDOController@edit');
Route::post('/kaidah/{id_kategori}/update', 'KategoriDOController@update');
Route::get('/kaidah/{id_kategori}/delete', 'KategoriDOController@delete');
