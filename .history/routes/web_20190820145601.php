...
Route::post('/kaidah/store', 'aidahController@store');
Route::get('/kaidah/{id_kategori}/edit', 'aidahController@edit');
Route::post('/kaidah/{id_kategori}/update', 'aidahController@update');
Route::get('/kaidah/{id_kategori}/delete', 'aidahController@delete');
