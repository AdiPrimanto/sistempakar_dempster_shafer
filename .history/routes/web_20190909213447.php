...
Route::get('/bobotbaru/{id_kategori}/show', 'BobotController@index');
Route::get('/bobotbaru', 'BobotController@index');
Route::get('/bobotbaru/{id_kategori}/delete', 'BobotController@delete');
